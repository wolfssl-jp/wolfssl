...
#define DoExpectBuf(x, y, z, op, er)                              \
    do                                                            \
    {                                                             \
        const byte *_x = (const byte *)(x);                       \
        const byte *_y = (const byte *)(y);                       \
